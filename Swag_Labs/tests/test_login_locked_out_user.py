...
class TestLogin(unittest.TestCase):
   ...
   def test_login_succesful(self):
       ...
       driver.find_element(*Locators.USERNAME_FIELD).send_keys(Credencial.locked_out_user_login)
       driver.find_element(*Locators.PASSWORD_FIELD).send_keys(Credencial.locked_out_user_passwd)
