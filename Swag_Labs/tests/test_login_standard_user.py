...
class TestLogin(unittest.TestCase):
    ...
    def test_login_succesful(self):
        ...
        driver.find_element(*Login_Page_Locators.USERNAME_FIELD).send_keys(Credencial.standard_user_login)
        driver.find_element(*Login_Page_Locators.PASSWORD_FIELD).send_keys(Credencial.standard_user_passwd)
